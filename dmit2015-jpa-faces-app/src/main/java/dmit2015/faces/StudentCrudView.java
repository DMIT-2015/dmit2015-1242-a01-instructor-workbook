...
public class StudentCrudView implements Serializable {
    ...
    public void onGenerateData() {
        try {
            ...
            var fakeStudent = Student.of(faker);
            selectedStudent.setFirstName(fakeStudent.getFirstName());
            selectedStudent.setLastName(fakeStudent.getLastName());
            selectedStudent.setCourseSection(fakeStudent.getCourseSection());
    ...
    public void onSave() {
        try {
            ...
            if (selectedId == null) {
                ...
                Messages.addGlobalInfo("Create was successful with generated id of {0}", createdStudent.getId());
