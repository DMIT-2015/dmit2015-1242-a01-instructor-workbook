...
//        driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(5));
    ...
    @ParameterizedTest
    @CsvSource(value = {
            "firstName, Bruce, lastName, Less, courseSection, DMIT2015-A01,",
            "firstName, Bruce, lastName, More, courseSection, DMIT2015-A01,",
            "firstName, Bruce, lastName, Enough, courseSection, DMIT2015-A01,",
    })
    void shouldCreate(
    ...
    @ParameterizedTest
    @CsvSource({
            "0, Bruce, Less, DMIT2015-A01",
            "1, Bruce, More, DMIT2015-A01",
            "2, Bruce, Enough, DMIT2015-A01",
    })
    void shouldList(
            int idIndex,
