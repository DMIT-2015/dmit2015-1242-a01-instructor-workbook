 ...
 *
 * curl command to send mail to username@nait.ca (change username@nait.ca an actual email address)
 * for webapp running on HTTP and @ApplicationPath("restapi") in JaxRsApplication.java
